            ...
            <template #renderItem="{ item }">
                <a-list-item>
                    <a-dropdown :trigger="['contextmenu']">
                        <a-card hoverable style="width: 120px" v-if="item.fileType == undefined">
                            <template #cover>
                        ...
                        <a-card hoverable style="width: 120px" v-if="item.fileType === 'image'">
                            <template #cover>
                                <img :style="{padding: '5px'}" :width="110" :higth="110"
                                    :src="item.fileImage"
                                    fallback="data:image/png;base64," />
                            </template>
                            <template #actions>
                        ...
                        <template #overlay>
                            <a-menu>
                                <a-menu-item key="1" @click="open(item)">
                                    <folder-open-filled />
                                    打开</a-menu-item>
                                <a-menu-item v-if="item.fileType != undefined" key="2">
                                    <eye-filled />
                                    预览</a-menu-item>
                                <a-menu-item key="3" @click="double_click(item)">
                                    <edit-filled />
                                    重命名</a-menu-item>
                                <a-menu-item v-if="item.fileType == undefined" key="4" @click="newCreate(item)">
                                    <folder-add-filled />
                                    新建文件夹</a-menu-item>
                                <a-menu-item />

<template>
    <div class="my-container" :style="{ textAlign:'center' }">
        <a-list :grid="{ gutter: gutter, column: column }" :data-source="listData">
            <template #renderItem="{ item }">
                <a-list-item>
                    ...
                    <a-dropdown v-if="item.fileType == 'video'" :trigger="['contextmenu']">
                        <a-card hoverable style="width: 120px">
                            <template #cover>
                    ...
                    <a-dropdown v-if="item.fileType == 'image'" :trigger="['contextmenu']">
                        <a-card hoverable style="width: 120px">
                            <template #cover>
                                <a-image :style="{padding: '5px'}" class="fixed-height-img" :src="item.fileImage"
                                    fallback="data:image/png;base64," >
                                </a-image>
                            </template>
                            <template #actions>
...
<script setup lang="ts">
    ...
    // 监听浏览器长度
    watch(windowWidth, (newQuestion, oldQuestion) => {
        const i = Math.floor((windowWidth - 200)/200)
        if (i == 0) {
            column.value = 1
        }else {
            column.value = i
